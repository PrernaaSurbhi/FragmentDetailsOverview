...
class SecondFrag :Fragment() {
    ...
    fun updateSecondEditText(newtext: CharSequence){
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.second_frag,container,false)
        editText = v.findViewById(R.id.ed_frag_two)
        button = v.findViewById<AppCompatButton?>(R.id.frag_two_button)
